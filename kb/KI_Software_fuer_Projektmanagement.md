...
Die KI-Software für das [Projektmanagement](https://de.wikipedia.org/wiki/Projektmanagement) ist ein sehr neues Thema, denn nur 23% der Befragten gaben an im Projektmanagement mit künstlicher Intelligenz gearbeitet zu haben. 
Obwohl 90% der Projektmanagement-Fachleute überzeugt sind vom Einsatz von KI im Projekt und Projektmanagement, scheinen dennoch nur 4% der Unternehmen KI großflächig einzusetzen. Die KI-Softwaren die am häufigsten verwendet werden sind beispielsweise [Analysetools](https://www.onlinemarketing-praxis.de/web-controlling/web-analyse-tools), [Chat-Bots](https://www.ibm.com/de-de/campaign/was-ist-ein-chatbot) oder [robotergestützte Prozessautomatisierung](https://de.wikipedia.org/wiki/Robotic_Process_Automation)[^1].
...
# Nutzen von KI-Software für Projektmanagement
Die Künstliche Intelligenz bietet ab einer gewissen Komplexität von Projekten, welche viel Pflege benötigen oder wenn die [Aufwandsabschätzung](https://de.wikipedia.org/wiki/Aufwandssch%C3%A4tzung_(Softwaretechnik)) sehr viel Zeit beansprucht, weshalb andere Tätigkeiten vernachlässigt werden[^4], eine Effizienzssteigerung[^5]. Bei der Verwendung von KI im Projektmanagement ist vor allem das maschinelle Lernen relevant, dabei unterstützt und löst die KI [Anwendungsprobleme](https://de.wikipedia.org/wiki/Programmfehler) im Projektmanagement. Des Weiteren werden anhand von Anwendungsfall und Datenlage die Künstlichen Intelligenzen fortlaufend trainiert, und optimieren dadurch die Entscheidungsfindung. Die KI lernt durch verschiedene Ansätze wie ["Supervised Learning"](https://de.wikipedia.org/wiki/%C3%9Cberwachtes_Lernen), ["Unsupervised Learning"](https://de.wikipedia.org/wiki/Un%C3%BCberwachtes_Lernen) und ["Reinforcement Learning"](https://de.wikipedia.org/wiki/Best%C3%A4rkendes_Lernen), welche im Bild 1 näher und kurz Beschrieben werden[^4]. 
...
- Webseite: [Künstliche Intelligenz](https://de.wikipedia.org/wiki/K%C3%BCnstliche_Intelligenz)
